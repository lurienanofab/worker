...
namespace Worker
{
    ...
    {
        private readonly List<AuthorizeBaseAttribute> _attributes;
        ...
        {
            _attributes = new List<AuthorizeBaseAttribute>();
    ...
    public class BasicAuthenticationAttribute : AuthorizeBaseAttribute
    {
    ...
    public class FormsAuthenticationAttribute : AuthorizeBaseAttribute
    {
        public override bool CheckAuthorization(HttpActionContext actionContext)
        {
    ...
    public class ApiKeyAuthenticationAttribute : AuthorizeBaseAttribute
    {
        public override bool CheckAuthorization(HttpActionContext actionContext)
        {
